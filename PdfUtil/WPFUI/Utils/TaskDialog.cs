...
namespace PdfUtil.WPFUI.Utils
{
    ...
    public class TaskDialog
    {
        ...
        private NativeMethods.TaskDialogCallbackProc callback = null;
            ...
            TASKDIALOG_COMMON_BUTTON_FLAGS CommonButtonFlags, Icon MainIcon, Icon FooterIcon, int Width)
        {
            ...
            // Set callback
            NativeMethods.TaskDialogCallbackProc callback = new NativeMethods.TaskDialogCallbackProc(this.TaskDialogCallback);
        ...
        private int TaskDialogCallback(IntPtr hwnd, NativeMethods.TASKDIALOG_NOTIFICATIONS msg, IntPtr wParam, IntPtr lParam, IntPtr refData)
        {
            if (msg == NativeMethods.TASKDIALOG_NOTIFICATIONS.TDN_CREATED)
            {
                // bring taskdialog window to the top
                NativeMethods.SetWindowPos(hwnd, new IntPtr(NativeMethods.HWND_TOPMOST), 0, 0, 0, 0, NativeMethods.SWP_NOSIZE | NativeMethods.SWP_NOMOVE);
                NativeMethods.SetWindowPos(hwnd, new IntPtr(NativeMethods.HWND_NOTOPMOST), 0, 0, 0, 0, NativeMethods.SWP_NOSIZE | NativeMethods.SWP_NOMOVE);
            }
