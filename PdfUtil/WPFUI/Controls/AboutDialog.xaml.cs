...
namespace PdfUtil.WPFUI.Controls
{
    ...
    public partial class AboutDialog : BaseWindow
    {
        ...
        public AboutDialog(PdfUtilView view)
        {
            InitializeComponent();
            _view = view;
            if (view.IsLoaded)
        ...
        private void InitAboutInfo()
        {
            ...
            int licenseType = -1;
            WinzipMethods.GetLicenseStatus(_view.SafeHandle, ref licenseType);
            ...
            TextBolck_VersionInfo_1.Text = Properties.Resources.WINZIP_TITLE + "® " + Properties.Resources.PDF_UTILITY_FRIENDLY_NAME + " " + exeVersion + " (" + buildVersionInfo + ") " + exeBit;
            TextBolck_VersionInfo_2.Text = Properties.Resources.WINZIP_TITLE + "® " + winzipVersion + type + test + " (" + buildVersionInfo + ") " + exeBit;
