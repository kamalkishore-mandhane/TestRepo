...
namespace PdfUtil.WPFUI.Controls
{
    ...
    public class FakeRibbonTwoLineText : Control
    {
        #region Constructors

        static FakeRibbonTwoLineText()
        {
            Type ownerType = typeof(FakeRibbonTwoLineText);
        ...
        public static readonly DependencyProperty TextDecorationsProperty = TextBlock.TextDecorationsProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty TextEffectsProperty = TextBlock.TextEffectsProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty BaselineOffsetProperty = TextBlock.BaselineOffsetProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        new public static readonly DependencyProperty PaddingProperty = TextBlock.PaddingProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty TextAlignmentProperty =
            TextBlock.TextAlignmentProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty TextTrimmingProperty =
            TextBlock.TextTrimmingProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty LineHeightProperty =
            TextBlock.LineHeightProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty LineStackingStrategyProperty =
            TextBlock.LineStackingStrategyProperty.AddOwner(typeof(FakeRibbonTwoLineText));
        ...
        public static readonly DependencyProperty TextProperty =
                    TextBlock.TextProperty.AddOwner(typeof(FakeRibbonTwoLineText),
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            if (_textBlock1 != null && _textBlock2 != null && _path != null)
            {
                ...
                if (!hasTwoLines)
                {
                    ...
                    VisualTreeHelperUtils.InvalidateMeasureForVisualAncestorPath<FakeRibbonTwoLineText>(_textBlock2);
                }
                else   // HasTwoLines
                {
        ...
        {
            return new FakeRibbonTwoLineTextAutomationPeer(this);
        }
