...
namespace PdfUtil.WPFUI.Controls
{
    ...
    /// </summary>
    public partial class PasswordControl : BaseUserControl, INotifyPropertyChanged
    {
        public static DependencyProperty PasswordProperty = DependencyProperty.Register("Password", typeof(string), typeof(PasswordControl), new PropertyMetadata(null, PasswordControlPropertyChanged));
        public event PropertyChangedEventHandler PropertyChanged;

        private static void PasswordControlPropertyChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            var control = o as PasswordControl;
            var password = e.NewValue as string;
            if (control != null && control.PasswordBox.Password != password)
            {
                control.PasswordBox.Password = password;
                control.SetPasswordBoxSelection(control.PasswordTextBox.SelectionStart, control.PasswordTextBox.SelectionLength);
            }
        }
