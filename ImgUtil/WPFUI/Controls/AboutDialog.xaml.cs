...
namespace ImgUtil.WPFUI.Controls
{
    ...
    public partial class AboutDialog : BaseWindow
    {
        ...
        public AboutDialog(ImgUtilView view)
        {
            InitializeComponent();
            _view = view;
            if (view.IsLoaded)
        ...
        private void InitAboutInfo()
        {
            ...
            TextBolck_VersionInfo_1.Text = Properties.Resources.WINZIP + "® " + Properties.Resources.IMAGE_UTILITY_FRIENDLY_NAME + " " + exeVersion + " (" + buildVersionInfo + ") " + exeBit;
