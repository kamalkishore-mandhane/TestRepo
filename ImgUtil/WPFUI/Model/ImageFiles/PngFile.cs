...
namespace ImgUtil.WPFUI.Model.ImageFiles
{
    ...
    class PngFile : ImageFile
    {
        ...
        public PngFile(string localPath, Aspose.Imaging.FileFormat format)
        ...
        {
            _previewImage = new PngBitmapDecoder(new Uri(_localPath), BitmapCreateOptions.PreservePixelFormat, BitmapCacheOption.OnLoad).Frames[0];
