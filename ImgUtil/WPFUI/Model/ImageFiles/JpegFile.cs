...
namespace ImgUtil.WPFUI.Model.ImageFiles
{
    ...
    class JpegFile : ImageFile
    {
        ...
        public JpegFile(string localPath, Aspose.Imaging.FileFormat format)
        ...
        {
            _previewImage = new JpegBitmapDecoder(new Uri(_localPath), BitmapCreateOptions.PreservePixelFormat, BitmapCacheOption.OnLoad).Frames[0];
