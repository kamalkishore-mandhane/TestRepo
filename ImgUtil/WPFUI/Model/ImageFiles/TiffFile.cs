...
{
    [DotNetSupportedImage(true)]
    class TiffFile : ImageFile
    {
        private Int32Rect _croppedRect;
        private Int32Rect _imageRect;

        public TiffFile(string localPath, Aspose.Imaging.FileFormat format)
        ...
        {
            _previewImage = new TiffBitmapDecoder(new Uri(_localPath), BitmapCreateOptions.PreservePixelFormat, BitmapCacheOption.OnLoad).Frames[0];
