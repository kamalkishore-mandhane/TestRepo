...
namespace ImgUtil.WPFUI.Utils
{
    ...
    public static class WinzipMethods
    {
        ...
        private static extern IntPtr CreateSession32(int serviceId, string accessPermission, string additionalCMDParameters);
        ...
        [DllImport("WzSharedServices32.dll", CharSet = CharSet.Unicode, EntryPoint = "AddToTeamsBGFolder", ExactSpelling = true)]
        private static extern bool AddToTeamsBGFolder32(IntPtr hwnd, WzCloudItem4 cloudItem);
        ...
        [DllImport("WzSharedServices32.dll", CharSet = CharSet.Unicode, EntryPoint = "SetWindowsDesktopBG", ExactSpelling = true)]
        private static extern bool SetWindowsDesktopBG32(IntPtr hwnd, WzCloudItem4 cloudItem);
        ...
        private static extern IntPtr CreateSession64(int serviceId, string accessPermission, string additionalCMDParameters);
        ...
        [DllImport("WzSharedServices64.dll", CharSet = CharSet.Unicode, EntryPoint = "AddToTeamsBGFolder", ExactSpelling = true)]
        private static extern bool AddToTeamsBGFolder64(IntPtr hwnd, WzCloudItem4 cloudItem);
        ...
        [DllImport("WzSharedServices64.dll", CharSet = CharSet.Unicode, EntryPoint = "SetWindowsDesktopBG", ExactSpelling = true)]
        private static extern bool SetWindowsDesktopBG64(IntPtr hwnd, WzCloudItem4 cloudItem);
        ...
        public static bool AddToTeamsBGFolder(IntPtr hwnd, WzCloudItem4 cloudItem)
        {
            if (Is32Bit())
            {
                return AddToTeamsBGFolder32(hwnd, cloudItem);
            }
            else
            {
                return AddToTeamsBGFolder64(hwnd, cloudItem);
            }
        }
        ...
        public static bool SetWindowsDesktopBG(IntPtr hwnd, WzCloudItem4 cloudItem)
        {
            if (Is32Bit())
            {
                return SetWindowsDesktopBG32(hwnd, cloudItem);
            }
            else
            {
                return SetWindowsDesktopBG64(hwnd, cloudItem);
            }
        }
