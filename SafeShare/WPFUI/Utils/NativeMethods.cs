...
namespace SafeShare.WPFUI.Utils
{
    internal static partial class NativeMethods
    {
        ...
        public static readonly Guid FolderRidDownloadsGuid = new Guid("374DE290-123F-4565-9164-39C4925E467B");
        ...
        #endregion Side by side load COM interface
        ...
        {
            uint DragEnter([In] IntPtr hwndTarget, [In, MarshalAs(UnmanagedType.Interface)] IDataObject dataObject, [In] ref POINT pt, [In] int effect);

            uint DragLeave();

            uint DragOver([In] ref POINT pt, [In] int effect);

            uint Drop([In, MarshalAs(UnmanagedType.Interface)] IDataObject dataObject, [In] ref POINT pt, [In] int effect);

            uint Show([In] bool show);
        }

        #endregion Drag Drop Helper
    }
