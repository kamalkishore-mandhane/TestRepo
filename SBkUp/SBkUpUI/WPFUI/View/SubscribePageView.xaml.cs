...
namespace SBkUpUI.WPFUI.View
{
    ...
    public partial class SubscribePageView : BasePage
    {
        ...
        public SubscribePageView(SBkUpView view)
        {
            _sBkUpView = view;
            InitializeComponent();
        }
        ...
        {
            _sBkUpView.HideUXNagBannerFrame();
        }
        ...
        private new void SetHighContrastTheme(bool highContrast)
        {
            ...
            if (highContrast)
            {
                this.Resources.MergedDictionaries[0].MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("/SBkUpUI;component/WPFUI/Themes/HighContrastTheme.xaml", UriKind.RelativeOrAbsolute) });
            }
            else
            {
                this.Resources.MergedDictionaries[0].MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("/SBkUpUI;component/WPFUI/Themes/WinZipColorTheme.xaml", UriKind.RelativeOrAbsolute) });
            }
        }
    }
}
