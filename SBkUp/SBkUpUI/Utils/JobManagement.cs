...
namespace SBkUpUI.Utils
{
    public class JobManagement : IDisposable
    {
        ...
        public JobManagement()
        {
            ...
            UInt32 limitFlag = (uint)(LimitFlags.JOB_OBJECT_LIMIT_KILL_ON_JOB_CLOSE | LimitFlags.JOB_OBJECT_LIMIT_SILENT_BREAKAWAY_OK);
        ...
        public void RemoveAssociatedCloseProcess()
        {
            UInt32 limitFlag = (uint)(LimitFlags.JOB_OBJECT_LIMIT_SILENT_BREAKAWAY_OK);
