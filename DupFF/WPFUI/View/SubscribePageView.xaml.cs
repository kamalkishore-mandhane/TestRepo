...
namespace DupFF.WPFUI.View
{
    ...
    public partial class SubscribePageView : BasePage
    {
        ...
        private DupFFView _dupFFView;
        private string _buyNowUrl;

        public SubscribePageView(DupFFView view)
        {
            _dupFFView = view;
            InitializeComponent();
        }

        public void InitDataContext(TrialPeriodMode mode, int trialDaysRemaining, bool isAlreadyRegistered, string buyNowUrl)
        {
            ...
            {
                _dupFFView.HideUXNagBannerFrame();
            }
            else
            {
